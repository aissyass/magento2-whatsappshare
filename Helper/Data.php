...
namespace PHPAISS\Whatsappshare\Helper;
...
class Data extends AbstractHelper
{
    ...
    /**
     * Retrieve config XML_PATH_WHATSAPP_SHARE_ENABLE
     *
     * @return string
     */
    public function whatsappshareEnable() {
        return $this->_scopeConfig->getValue(self::XML_PATH_WHATSAPP_SHARE_ENABLE);
    }

    /**
     * Retrieve config XML_PATH_WHATSAPP_SHARE_SIZE
     *
     * @return string
     */
    public function whatsappshareSize() {
        return $this->_scopeConfig->getValue(self::XML_PATH_WHATSAPP_SHARE_SIZE);
    }

    /**
     * Retrieve config XML_PATH_WHATSAPP_SHARE_TEXT
     *
     * @return string
     */
    public function whatsappshareText() {
